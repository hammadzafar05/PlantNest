                    ...
                    <div class="card">
                            ...
                            <div class="p-4">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-1 overflow-hidden">
                                        ...
                                        <p class="text-muted text-truncate mb-0">Add plant category below</p>
                                    </div>
                        ...
                        <div id="addproduct-billinginfo-collapse" class="collapse show"
                            ...
                            <div class="p-4 border-top">
                                <form method="post" action="{{ url('admin/categories/AddPlantCategory') }}"
                                    ...
                                    <table border="1" class="table">
                                        ...
                                        @foreach ($plantCategories as $category)
                                            <tr>
                                                ...
                                                <td>{{ $category->name }}</td>
                                                <td>
                                                    <a href="{{ url('admin/categories/editPlantCategory/' . $category->id) }}"
                                                        class="btn btn-primary">Edit</a>
                                                    {{-- <a href="{{ url('admin/categories/deletePlantCategory/' . $category->id) }}"
                                                        class="btn btn-danger">Delete</a> --}}
                                                    <a onclick="deleteData('/admin/deletePlantCategory/'+{{$category->id }})"
                                                        class="btn btn-danger">Delete</a>
                                                </td>
                                            </tr>
                                        @endforeach
