                ...
                <div class="card">
                    ...
                    <div id="addproduct-billinginfo-collapse" class="collapse show" data-bs-parent="#addproduct-accordion">
                        <div class="p-4 border-top">
                            <form method="post" action="{{url('admin/categories/AddPlantCategory')}}" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                <div class="col-md-12">
                                <div class="mb-3">
                            ...
                            <table border="1" class="table">
                                ...
                                @foreach ($plantCategories as $category)
                                    <tr>
                                        ...
                                        <td>{{ $category->name }}</td>
                                        <td>
                                            <a href="{{url('admin/categories/editPlantCategory/'.$category->id)}}" class="btn btn-primary">Edit</a>
