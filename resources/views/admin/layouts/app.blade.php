                    ...
                    <div class="dropdown d-inline-block">
                        <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                            ...
                            <img class="rounded-circle header-profile-user"
                                src="{{ asset('assets/backend/images/users/avatar-4.png') }}" alt="Header Avatar">
                            <span
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <a class="dropdown-item" href="{{ url('/') }}"><i
                                    class="uil uil-sign-in-alt font-size-18 align-middle text-muted me-1"></i> <span
                                    class="align-middle">Go to Website</span></a>
