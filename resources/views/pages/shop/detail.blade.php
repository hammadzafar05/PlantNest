            ...
            <div class="col-lg-6 col-md-6">
                <div class="product-details-tab">
                    <div id="img-1" class="zoomWrapper single-zoom">
                        <a href="#">
                            <img id="zoom1" src="{{asset('assets/frontend/img/product/productbig4.jpg')}}"
                                data-zoom-image="{{asset('assets/frontend/img/product/productbig4.jpg')}}" alt="big-1">
                        </a>
                    </div>
                        ...
                        <ul class="s-tab-zoom owl-carousel single-product-active" id="gallery_01">
                            <li>
                                <a href="#" class="elevatezoom-gallery active" data-update=""
                                    data-image="{{asset('assets/frontend/img/product/productbig4.jpg')}}"
                                    data-zoom-image="{{asset('assets/frontend/img/product/productbig4.jpg')}}">
                                    <img src="{{asset('assets/frontend/img/product/productbig4.jpg')}}" alt="zo-th-1" />
                                </a>
                            ...
                            <li>
                                <a href="#" class="elevatezoom-gallery active" data-update=""
                                    ...
                                    <img src="{{asset('assets/frontend/img/product/productbig2.jpg')}}" alt="zo-th-1" />
                                </a>

                            </li>
                            <li>
                                <a href="#" class="elevatezoom-gallery active" data-update=""
                                    data-image="{{asset('assets/frontend/img/product/productbig3.jpg')}}"
                                    data-zoom-image="{{asset('assets/frontend/img/product/productbig3.jpg')}}">
                                    <img src="{{asset('assets/frontend/img/product/productbig3.jpg')}}" alt="zo-th-1" />
                                </a>
                        ...
                        <figure>
                            <div class="product_thumb">
                                <a class="primary_img" href="product-details.html"><img
                                        src="{{asset('assets/frontend/img/product/product1.jpg')}}" alt=""></a>
                ...
                <div class="col-lg-3">
                    <article class="single_product">
                        <figure>
                            <div class="product_thumb">
                                <a class="primary_img" href="product-details.html"><img
                                        src="{{asset('assets/frontend/img/product/product2.jpg')}}" alt=""></a>
                                <div class="label_product">
                ...
                <div class="col-lg-3">
                    <article class="single_product">
                        <figure>
                            <div class="product_thumb">
                                <a class="primary_img" href="product-details.html"><img
                                        src="{{asset('assets/frontend/img/product/product3.jpg')}}" alt=""></a>
                                <div class="label_product">
                ...
                <div class="col-lg-3">
                    <article class="single_product">
                        <figure>
                            <div class="product_thumb">
                                <a class="primary_img" href="product-details.html"><img
                                        src="{{asset('assets/frontend/img/product/product4.jpg')}}" alt=""></a>
                                <div class="label_product">
                ...
                <div class="col-lg-3">
                    <article class="single_product">
                        <figure>
                            <div class="product_thumb">
                                <a class="primary_img" href="product-details.html"><img
                                        src="{{asset('assets/frontend/img/product/product5.jpg')}}" alt=""></a>
                                <div class="label_product">
                ...
                <div class="col-lg-3">
                    <article class="single_product">
                        <figure>
                            <div class="product_thumb">
                                <a class="primary_img" href="product-details.html"><img
                                        src="{{asset('assets/frontend/img/product/product6.jpg')}}" alt=""></a>
                                <div class="label_product">
                                    <span class="label_sale">-9%</span>
                                </div>
                                <div class="action_links">
                ...
                <div class="col-lg-3">
                    <article class="single_product">
                        <figure>
                            <div class="product_thumb">
                                <a class="primary_img" href="product-details.html"><img
                                        src="{{asset('assets/frontend/img/product/product7.jpg')}}" alt=""></a>
                                <div class="label_product">
                ...
                <div class="col-lg-3">
                    <article class="single_product">
                        <figure>
                            <div class="product_thumb">
                                <a class="primary_img" href="product-details.html"><img
                                        src="{{asset('assets/frontend/img/product/product8.jpg')}}" alt=""></a>
                                <div class="label_product">
                                    <span class="label_sale">-6%</span>
                                </div>
                                <div class="action_links">
                ...
                <div class="col-lg-3">
                    <article class="single_product">
                        <figure>
                            <div class="product_thumb">
                                <a class="primary_img" href="product-details.html"><img
                                        src="{{asset('assets/frontend/img/product/product9.jpg')}}" alt=""></a>
                                <div class="label_product">
                                    <span class="label_sale">-8%</span>
                                </div>
                                <div class="action_links">
                ...
                <div class="col-lg-3">
                    <article class="single_product">
                        <figure>
                            <div class="product_thumb">
                                <a class="primary_img" href="product-details.html"><img
                                        src="{{asset('assets/frontend/img/product/product10.jpg')}}" alt=""></a>
                                <div class="label_product">
                                    <span class="label_sale">-9%</span>
                                </div>
                                <div class="action_links">
